...
export const AnalysisDisplaySkeleton = () => (
    ...
    {[...Array(4)].map((_, i) => (
      <div key={i} className="bg-white shadow-md rounded-lg p-4 animate-pulse">
        ...
        <div className="text-center">
          <div className="h-4 w-20 bg-gray-200 rounded mb-2 mx-auto"></div>
...
export const NewSessionSkeleton = () => (
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div className="mb-8">
      ...
      <div className="h-8 w-48 bg-gray-200 rounded mt-4 animate-pulse"></div>
    </div>
    ...
    <div className="bg-white shadow rounded-lg p-6 mb-6">
      ...
      <div className="max-w-xl">
        <div className="flex gap-4">
          <div className="block w-full h-10 bg-gray-200 rounded animate-pulse"></div>
